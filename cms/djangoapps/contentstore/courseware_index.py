...
class CourseAboutSearchIndexer(object):
    ...
    ABOUT_INFORMATION_TO_INCLUDE = [
        ...
        AboutInfo("ai_sector_yn", AboutInfo.PROPERTY, AboutInfo.FROM_COURSE_PROPERTY),
        AboutInfo("basic_science_sectotr_yn", AboutInfo.PROPERTY, AboutInfo.FROM_COURSE_PROPERTY),
