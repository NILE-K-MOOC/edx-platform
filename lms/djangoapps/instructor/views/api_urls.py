...
urlpatterns = patterns(
    ...
    url(r'^get_contents_stat',
        'instructor.views.api.get_contents_stat', name="get_contents_stat"),
    url(r'^get_contents_view',
        'instructor.views.api.get_contents_view', name="get_contents_view"),
