...
def courses(request):
    ...
    parameter_list = ['job_edu_yn', 'fourth_industry_yn', 'home_course_yn', 'home_course_step', 'ribbon_yn', 'linguistics', 'linguistics_yn', 'classfy', 'middle_classfy', 'ai_sec_yn', 'basic_science_sec_yn']
