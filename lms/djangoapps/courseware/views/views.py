...
def courses(request):
    ...
    parameter_list = ['job_edu_yn', 'fourth_industry_yn', 'home_course_yn', 'home_course_step', 'ribbon_yn', 'linguistics', 'linguistics_yn', 'liberal_arts_yn', 'career_readiness_competencies_yn', 'classfy', 'middle_classfy', 'ai_sec_yn', 'basic_science_sec_yn', 'matchup_yn']
...
@ensure_csrf_cookie
@cache_if_anonymous()
def privacy_old8(request):
    return render_to_response(
        "courseware/privacy_old8.html"
    )


@ensure_csrf_cookie
@cache_if_anonymous()
def privacy_old9(request):
    return render_to_response(
        "courseware/privacy_old9.html"
    )


@ensure_csrf_cookie
@cache_if_anonymous()
def privacy_old10(request):
    return render_to_response(
        "courseware/privacy_old10_n.html"
    )
