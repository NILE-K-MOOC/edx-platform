...
urlpatterns = [
    ...
    url(r'^invitation-confirm$', branding_views.invi, name='invitation_confirm'),

    # url(r'^invitation-banner$', branding_views.InvitationBannerView, name='invitation_banner'),
