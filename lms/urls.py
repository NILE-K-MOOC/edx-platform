...
urlpatterns = [
    ...
    url(r'^ssamlsubmit$', branding_views.ssaml_submit, name='ssamlsubmit'),
    ...
    url(r'^invitation-banner-udemy$', branding_views.invitation_banner_udemy, name='invitation_banner_udemy'),
...
if settings.FEATURES.get('ENABLE_COMBINED_LOGIN_REGISTRATION'):
    ...
    urlpatterns += [
        ...
        url(r'^removememberdel/$', student_account_views.remove_member_del,
            {'initial_mode': 'memberdel'}, name='remove_member_del')
    ]
else:
    # Serve the old views
    urlpatterns += [
