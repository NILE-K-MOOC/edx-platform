...
urlpatterns = (
    ...
    url(r'^multisite_error/$', 'branding.views.multisite_error', name="multisite_error"),
    ...
    url(r'^active_account/(?P<email>.*?)$', 'student.views.active_account', name='active_account'),
    ...
    url(r'^series_view/(?P<id>.*?)/about/$', 'community.views.series_about', name='series_about'),
    url(r'^series_view/(?P<id>.*?)/enroll$', 'community.views.series_enroll', name='series_enroll'),
...
urlpatterns += (
    ...
    url(r'^Privacy-Policy_old4/?$', 'courseware.views.views.privacy_old4', name="privacy_old4"),
