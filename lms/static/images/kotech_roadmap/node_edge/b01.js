...
var edges = [
  ...
  { from: 6, to: 12, color: { opacity: OP_HIGH } },
  { from: 1, to: 12, color: { opacity: OP_HIGH } },
  { from: 10, to: 12, color: { opacity: OP_HIGH } },
  { from: 2, to: 12, color: { opacity: OP_HIGH } },

  { from: 1, to: 13, color: { opacity: OP_HIGH } },
  { from: 6, to: 13, color: { opacity: OP_MID } },
  { from: 2, to: 13, color: { opacity: OP_HIGH } },
  { from: 11, to: 13, color: { opacity: OP_MID } },
  { from: 12, to: 13, color: { opacity: OP_HIGH } },
  { from: 14, to: 13, color: { opacity: OP_MID } },
  ...
  { from: 14, to: 18, color: { opacity: OP_MID } },
  ...
  { from: 11, to: 20, color: { opacity: OP_HIGH } },
  { from: 12, to: 20, color: { opacity: OP_MID } },
  { from: 17, to: 20, color: { opacity: OP_HIGH } },

  { from: 15, to: 21, color: { opacity: OP_HIGH } },
  { from: 11, to: 21, color: { opacity: OP_MID } },
