var nodes = [
  { id: 0, label: "Introduction to CS and Programming\n(컴퓨터과학 개론 및 프로그래밍)\n파이썬 프로그래밍 외 1건", shape: VIS_SHAPE, level: 0, color: NORMAL_COLOR, link: [['파이썬 프로그래밍', 'HGUk+HGU02'], ['AI 기초프로그래밍(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  ...
  { id: 8, label: "Understanding Artificial Intelligence\n(인공지능의 이해)\nICBM+AI개론(일부 유사 강좌)", shape: VIS_SHAPE, level: 4, color: NULL_COLOR, link: "KoreaUnivK+ku_eng_004" },
  ...
  { id: 18, label: "Computer Vision\n(컴퓨터비전)\n영상 처리 및 실습(전남대학교) 외 1건", shape: VIS_SHAPE, level: 9, color: MATCH_COLOR, link: [['딥러닝 영상분석(코리아헤럴드)', 'http://www.abedu.co.kr/AI_MF/lecture/ps/4/is/6'], ['영상처리와 패턴인식', 'SMUk+FD_SMU03']] },
