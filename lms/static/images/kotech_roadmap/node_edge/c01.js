var nodes = [
  { id: 0, label: "Introduction Programming for Everyone\n(프로그래밍 개론)\n머신러닝을 위한 파이썬 기초(Match業 강좌)", shape: VIS_SHAPE, level: 0, color: NORMAL_COLOR, link: "https://iclass.postech.ac.kr/courses/5d6cdd4ec5728b2c694db285" },
  { id: 1, label: "Basic(Highschool)\nMathematics(기초 수학)\n개발예정강좌", shape: VIS_SHAPE, level: 0, color: NULL_COLOR, link: "" },
  { id: 2, label: "AI Ethics(인공지능 윤리)\n인격과 로봇", shape: VIS_SHAPE, level: 0, color: NORMAL_COLOR, link: "CKUk+CORE_CKU03k" },
