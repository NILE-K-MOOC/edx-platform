var nodes = [
  ...
  { id: 3, label: "Introduction to CS and Programming\n(컴퓨터과학 개론 및 프로그래밍)\n파이썬 프로그래밍", shape: VIS_SHAPE, level: 1, color: NORMAL_COLOR, link: [['파이썬 프로그래밍', 'HGUk+HGU02'], ['AI 기초프로그래밍(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  { id: 4, label: "Introduction to Statistics\n(통계학 개론)\n통계학의 이해 I 외 3건", shape: VIS_SHAPE, level: 1, color: NORMAL_COLOR, link: [['통계학의 이해 I', 'SookmyungK+SM_sta_004k'], ['통계학의 이해 II', 'SookmyungK+SM_sta_009k'], ['[A.I. SERIES] R을 활용한 통계학개론', 'PNUk+RS_C01'], ['머신러닝을 위한 R기초와 통계(고려사이버대학교)', 'http://future.cuk.edu/local/paid/application_intro.php?id=3']] },
  { id: 5, label: "Probability and Discrete Mathematics\n(확률과 이산수학)\nAI 기초수학Ⅱ(확률 및 통계)\n(전남대학교) 외 1건", shape: VIS_SHAPE, level: 1, color: MATCH_COLOR, link: [['AI 기초수학Ⅱ(확률 및 통계)(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx'], ['Mathematical Fundamentals for Data Science', 'KoreaUnivK+ku_eng_002']] },
  { id: 6, label: "Calculus(미적분학)\n알고 보면 쉬운 미적분 이론 외 2건", shape: VIS_SHAPE, level: 1, color: NORMAL_COLOR, link: [['알고 보면 쉬운 미적분 이론', 'POSTECHk+MATH311'], ['미적분학 I - 활용을 중심으로', 'SKKUk+SKKU_EXGB506_01K'], ['미적분학 II-다변수 미적분학', 'SKKUk+SKKU_2017_05-01']] },
  { id: 7, label: "Linear Algebra(선형대수)\n선형대수학 외 3건", shape: VIS_SHAPE, level: 1, color: NORMAL_COLOR, link: [['선형대수학', 'SKKUk+SKKU_2017_01'], ['쉽게 시작하는 기초선형대수학', 'UOSk+ACE_UOS06'], ['Mathematical Fundamentals for Data Science', 'KoreaUnivK+ku_eng_002'], ['머신러닝을 위한 선형대수와 최적화(포항공과대학교)', 'https://iclass.postech.ac.kr/courses/5d6cde23c5728b29054d5094']] },

  { id: 8, label: "Math for Artificial Intelligence\n(인공지능을 위한 수학)\n머신 러닝을 위한 기초 수학 및 통계\n(코리아헤럴드) 외 3건", shape: VIS_SHAPE, level: 2, color: MATCH_COLOR, link: [['머신 러닝을 위한 기초 수학 및 통계', 'http://www.abedu.co.kr/AI/lecture/ps/1/is/4'], ['머신러닝을 위한 수학적 기초(고려사이버대학교)', 'http://future.cuk.edu/local/paid/application_intro.php?id=3'], ['AI 기초수학 I(선형대수) (전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx'], ['AI 기초수학II(확률 및 통계) (전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  ...
  { id: 14, label: "Big Data Analytics\n(빅 데이터 분석)\n빅 데이터 첫 걸음 외 9건", shape: VIS_SHAPE, level: 5, color: NORMAL_COLOR, link: [['빅 데이터 첫 걸음', 'POSTECHk+CSED490k'], ['빅데이터의 세계 원리와 응용', 'EwhaK+EW11237K'], ['빅데이터 플랫폼 구축 절차와 요소기술(코리아헤럴드)', 'http://www.abedu.co.kr/BigData/lecture/ps/11/is/18'], ['빅데이터 분석기획 및 방법론(코리아헤럴드)', 'http://www.abedu.co.kr/BigData/lecture/ps/10/is/18'], ['데이터 분석을 위한 분산처리 프레임워크(코리아헤럴드)', 'http://www.abedu.co.kr/AI/lecture/ps/8/is/16'], ['빅데이터와 인공지능의 응용', 'SNUk+SNU052_011k'], ['빅데이터와 머신러닝 소프트웨어', 'SNUk+SNU051_011k'], ['빅데이터와 텍스트마이닝', 'SejonguniversityK+SJMOOC10K'], ['(개발중) 빅데이터 분석 및 처리 기술', ''], ['(개발중) AWS 기반 IoT 빅데이터 실습 및 활용', '']] },
  ...
  { id: 17, label: "Introduction to Machine Learning\n(기계학습 개론)\n머신러닝 외 9건", shape: VIS_SHAPE, level: 7, color: NORMAL_COLOR, link: [['머신러닝', 'SNUk+SNU050_011k'], ['Machine Learning for Data Science', 'KoreaUnivK+ku_eng_003'], ['자율주행을 위한 머신러닝', 'SKKUk+SKKU_30'], ['머신러닝-지도학습(고려사이버대학교)', 'http://future.cuk.edu/local/paid/application_intro.php?id=3'], ['머신러닝-비지도학습(고려사이버대학교)', 'http://future.cuk.edu/local/paid/application_intro.php?id=3'], ['지도학습:회귀(포항공과대학교)', 'https://iclass.postech.ac.kr/courses/5d6db0eec5728b505b13d593'], ['지도학습:분류(포항공과대학교)', 'https://iclass.postech.ac.kr/courses/5d6db194c5728b50b04d5fb3'], ['비지도학습:군집화와 차원축소(포항공과대학교)', 'https://iclass.postech.ac.kr/courses/5d6db210c5728b5081032723'], ['기계학습 입문(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx'], ['R을 활용한 머신러닝(코리아헤럴드)', 'http://www.abedu.co.kr/AI/lecture/ps/2/is/4']] },

  { id: 18, label: "Introduction to Deep Learning\n(딥러닝 개론)\n딥러닝 개론", shape: VIS_SHAPE, level: 8, color: NORMAL_COLOR, link: [['딥러닝 개론', 'DGUk+DGU_006k+DGU_006k'], ['심층학습(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  { id: 19, label: "Advanced Machine Learning\n(고급 기계학습)\n매칭강좌없음", shape: VIS_SHAPE, level: 8, color: NULL_COLOR, link: "" },

  { id: 20, label: "Deep Learning Application and Practice\n(딥러닝 응용 및 실습)\n파이썬으로 배우는 기계학습 입문 외 7건", shape: VIS_SHAPE, level: 9, color: NORMAL_COLOR, link: [['파이썬으로 배우는 기계학습 입문', 'HGUk+HGU05'], ['TensorFlow(한국능률협회)', 'http://www.dataedu.kr/course-cat/매치업_딥러닝/'], ['Basic Definition for Deep Learning(한국능률협회)', 'http://www.dataedu.kr/course-cat/매치업_딥러닝/'], ['Deep Learning(한국능률협회)', 'http://www.dataedu.kr/course-cat/매치업_딥러닝/'], ['Deep Learning with TensorFlow(한국능률협회)', 'http://www.dataedu.kr/course-cat/매치업_딥러닝/'], ['파이썬을 활용한 딥러닝 2(코리아헤럴드)', 'http://www.abedu.co.kr/AI/lecture/ps/5/is/4'], ['파이썬을 활용한 딥러닝 3(코리아헤럴드)', 'http://www.abedu.co.kr/AI/lecture/ps/6/is/4'], ['(개발중)딥러닝개론 및 응용', '']] },
  ...
  { id: 25, label: "Natural Language Processing\n(자연어처리)\n자연어처리 및 실습\n(전남대학교) 외 2건", shape: VIS_SHAPE, level: 11, color: MATCH_COLOR, link: [['자연어처리 및 실습(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx'], ['텍스트 마이닝 실전 및 분석', 'YSUk+FD_YSU_LIS01k'], ['빅데이터와 텍스트마이닝', 'SejonguniversityK+SJMOOC10K']] },
  { id: 26, label: "Applied Artificial Intelligence\n(인공지능 응용)\n빅데이터와 인공지능의 응용 외 5건", shape: VIS_SHAPE, level: 11, color: NORMAL_COLOR, link: [['빅데이터와 인공지능의 응용', 'SNUk+SNU052_011k'], ['바이오헬스 빅데이터 마이닝', 'KKUk+CK_KKUkbio002'], ['경영데이터마이닝', 'HYUk+HYUBUS3099k'], ['빅데이터와 머신러닝 소프트웨어', 'SNUk+SNU051_011k'], ['클라우드 컴퓨팅과 인공지능', 'KoreaUnivK+ku_eng_006'], ['ICBM+AI 기술을 접목한 리빙랩 설계 입문', 'KoreaUnivK+ku_eng_007']] },
];
var edges = [
