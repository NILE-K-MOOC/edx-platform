var nodes = [
  ...
  { id: 19, label: "CoreEssAI 4\nAdvanced Machine Learning", shape: VIS_SHAPE, level: 8, color: NULL_COLOR, link: "" },

  { id: 20, label: "CoreElecAI 2\nHGUk+HGU05\n파이썬으로 배우는 기계학습 입문", shape: VIS_SHAPE, level: 9, color: NORMAL_COLOR, link: "" },
  { id: 21, label: "CoreElecAdv 1\nTopics in Artificial Intelligence", shape: VIS_SHAPE, level: 9, color: NULL_COLOR, link: "" },
  ...
  { id: 25, label: "SpcElecCV 1\nSMUk+FD_SMU03\n영상처리와 패턴인식", shape: VIS_SHAPE, level: 11, color: NORMAL_COLOR, link: "" },
  { id: 26, label: "SpcElecRB 2\nSEOULTECHk+SMOOC04k\nMobile Robot Perception and Navigation", shape: VIS_SHAPE, level: 11, color: NORMAL_COLOR, link: "" },
  { id: 27, label: "CoreElecAdv 4\nApplied Artificial Intelligence", shape: VIS_SHAPE, level: 11, color: NULL_COLOR, link: "" },
  { id: 28, label: "SpcElecCS 5\nAutonomous Agents", shape: VIS_SHAPE, level: 11, color: NULL_COLOR, link: "" },
];
var edges = [
