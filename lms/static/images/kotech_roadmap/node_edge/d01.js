...
var edges = [
  ...
  { from: 11, to: 19, color: { opacity: OP_HIGH } },
  ...
  { from: 20, to: 24, color: { opacity: OP_MID } },
  ...
  { from: 25, to: 26, color: { opacity: OP_MID } },
  ...
  { from: 17, to: 29, color: { opacity: OP_MID } },
  { from: 8, to: 29, color: { opacity: OP_HIGH } },
  { from: 23, to: 29, color: { opacity: OP_MID } },
];