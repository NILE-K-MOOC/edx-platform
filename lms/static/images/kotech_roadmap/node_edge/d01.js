var nodes = [
  ...
  { id: 18, label: "Introduction to Deep Learning\n(딥러닝 개론)\n딥러닝 개론 외 1건", shape: VIS_SHAPE, level: 8, color: NORMAL_COLOR, link: [['딥러닝 개론', 'DGUk+DGU_006k+DGU_006k'], ['심층학습(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  ...
  { id: 24, label: "Computer Vision\n(컴퓨터비전)\n딥러닝 영상분석(코리아헤럴드) 외 1건", shape: VIS_SHAPE, level: 10, color: MATCH_COLOR, link: [['딥러닝 영상분석(코리아헤럴드)', 'http://www.abedu.co.kr/AI_MF/lecture/ps/4/is/6'], ['영상처리와 패턴인식', 'SMUk+FD_SMU03']] },
  ...
  { id: 27, label: "Applied Artificial Intelligence\n(인공지능 응용)\nICBM+AI개론(일부 유사 강좌)", shape: VIS_SHAPE, level: 11, color: NULL_COLOR, link: "KoreaUnivK+ku_eng_004" },
