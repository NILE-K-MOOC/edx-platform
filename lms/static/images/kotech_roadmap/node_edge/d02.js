var nodes = [
  ...
  { id: 3, label: "Introduction to CS and Programming\n(컴퓨터과학 개론 및 프로그래밍)\n파이썬 프로그래밍 외 1건", shape: VIS_SHAPE, level: 1, color: NORMAL_COLOR, link: [['파이썬 프로그래밍', 'HGUk+HGU02'], ['AI 기초프로그래밍(전남대학교)', 'https://www.matchup.kr/comm/pageView.do?page=biz/field/ai']] },
  { id: 4, label: "Introduction to Statistics\n(통계학 개론)\n통계학의 이해 I 외 3건", shape: VIS_SHAPE, level: 1, color: FEED_COLOR, link: [['통계학의 이해 I', 'SookmyungK+SM_sta_004k'], ['통계학의 이해 II', 'SookmyungK+SM_sta_009k'], ['[A.I. SERIES] R을 활용한 통계학개론', 'PNUk+RS_C01'], ['머신러닝을 위한 R기초와 통계(고려사이버대학교)', 'https://www.matchup.kr/comm/pageView.do?page=biz/field/ai']] },
  ...
  { id: 7, label: "Linear Algebra(선형대수)\n선형대수학 외 3건", shape: VIS_SHAPE, level: 1, color: FEED_COLOR, link: [['선형대수학', 'SKKUk+SKKU_2017_01'], ['쉽게 시작하는 기초선형대수학', 'UOSk+ACE_UOS06'], ['Mathematical Fundamentals for Data Science', 'KoreaUnivK+ku_eng_002'], ['머신러닝을 위한 선형대수와 최적화(포항공과대학교)', 'https://www.matchup.kr/comm/pageView.do?page=biz/field/ai']] },
  ...
  { id: 22, label: "Introduction to Deep Learning\n(딥러닝 개론)\n딥러닝 개론 외 1건", shape: VIS_SHAPE, level: 9, color: NORMAL_COLOR, link: [['딥러닝 개론', 'DGUk+DGU_006k+DGU_006k'], ['심층학습(전남대학교)', 'https://www.matchup.kr/comm/pageView.do?page=biz/field/ai']] },
