var nodes = [
  ...
  { id: 6, label: "AI Etics(인공지능 윤리)\n인격과 로봇(일부 유사 강좌) 외 1건", shape: VIS_SHAPE, level: 1, color: EXIST_COLOR, link: [['인격과 로봇', 'CKUk+CORE_CKU03k'], ['포스트휴먼 인문학', 'EwhaK+CORE_EW17002C']] },

  { id: 7, label: "Introduction to CS and Programming\n(컴퓨터과학 개론 및 프로그래밍)\n파이썬 프로그래밍 외 1건", shape: VIS_SHAPE, level: 2, color: NORMAL_COLOR, link: [['파이썬 프로그래밍', 'HGUk+HGU02'], ['AI 기초프로그래밍(전남대학교)', 'https://sleonline.jnu.ac.kr/Course/Course100.aspx']] },
  ...
  { id: 14, label: "Understanding Artificial Intelligence\n(인공지능의 이해)\nICBM+AI개론(일부 유사 강좌)", shape: VIS_SHAPE, level: 5, color: NULL_COLOR, link: "KoreaUnivK+ku_eng_004" },
  ...
  { id: 24, label: "Computer Vision\n(컴퓨터비전)\n딥러닝 영상분석(코리아헤럴드) 외 1건", shape: VIS_SHAPE, level: 9, color: MATCH_COLOR, link: [['딥러닝 영상분석(코리아헤럴드)', 'http://www.abedu.co.kr/AI_MF/lecture/ps/4/is/6'], ['영상처리와 패턴인식', 'SMUk+FD_SMU03']] },
