...
define([
    ...
    return Backbone.View.extend({
        ...
        renderFacet: function (facetKey, options) {
            //html result return
            //console.log('refine_sidebar-renderFacet function: [facetName]' + this.facetName(facetKey)+":[renderOptions]" + this.renderOptions(options));
        ...
        render: function () {
            ...
            this.collection.comparator = function(model) {
                ...
                //console.log('refine_sidebar-render function:' + i++ + "-" + model.get('facet')+":" + model.get('term'));
